...
namespace BlazorApp1
{
    public static class Database
    {
        ...
        private static List<House> generateData()
        {
            ...
            data.Add(new House(1, "1700 Stratford Court SE", 200000.00, 800, 4, 4, "Single-Family", 1980, new String[] { "houseimages/house1.jpg", "houseimages/bathroom1.jpg", "houseimages/livingroom1.jpg", "houseimages/kitchen1.jpg" }, new DateTime(2022, 10, 05), new String[] {perks[0],perks[1],perks[2],perks[3]}));
            data.Add(new House(2, "2298 Belmeadow Drive NW", 250000.00, 1000, 4, 4, "Single-Family", 1990, new String[] { "houseimages/house2.jpg", "houseimages/bathroom2.jpg", "houseimages/livingroom2.jpg", "houseimages/kitchen2.jpg" }, new DateTime(2022, 11, 06), new String[] { perks[4],perks[5],perks[6],perks[7] }));
            data.Add(new House(3, "4008 Pinewood Drive NE", 150000.00, 600, 1, 1, "Apartment", 2015, new String[] { "houseimages/apartment1.jpg", "houseimages/bathroom3.jpg", "houseimages/livingroom3.jpg", "houseimages/kitchen3.jpg" }, new DateTime(2022, 05, 25), new String[] { perks[8],perks[8],perks[10],perks[11] }));
            ...
            data.Add(new House(17, "154 Church Street SE", 150000.00, 900, 3, 3, "Apartment", 2021, new String[] { "houseimages/condo.jpg", "houseimages/tower.jpg", "houseimages/foyer.jpg", "houseimages/bathroom.jpg" }, new DateTime(2022, 08, 25), new String[] { perks[3],perks[15],perks[5],perks[9] }));
